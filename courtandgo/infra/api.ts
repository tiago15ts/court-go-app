...
api.route("POST /reservations/by-court-ids-and-date", {
...
api.route("GET /courts/{clubID}", { handler: "functions/court/byClub.handler" });
...
api.route("GET /clubs/{id}", { handler: "functions/club/getById.handler" });
...
api.route("GET /clubs/filter", { handler: "functions/club/getFiltered.handler" });
