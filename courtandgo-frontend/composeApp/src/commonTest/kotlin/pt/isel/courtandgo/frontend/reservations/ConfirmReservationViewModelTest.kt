...
class ConfirmReservationViewModelTest {
    ...
    fun emitsSuccessState_whenReservationIsPlacedSuccessfully() = runTest {
        viewModel.placeReservation(
            playerId = 1,
            courtId = 1,
            startDateTime = LocalDateTime(2025, 12, 10, 10, 0),
            pricePerHour = 20.0
        )
        ...
        assertEquals(LocalDateTime(2025, 12, 10, 10, 0), reservation.startTime)
        assertEquals(LocalDateTime(2025, 12, 10, 11, 0), reservation.endTime)
